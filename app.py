...
try:
    ...
    <div class="main-header">
        <h1 style='font-size:3em; margin:0; color:#000000;'>👥 Live CRM Client Profiles</h1>
        <p style='font-size:1.2em; margin:0.5rem 0 0 0; opacity:0.9; color:#000000;'>
...
def format_field_value(value, field_name):
    ...
    try:
        ...
        if field_name == 'email' and '@' in value_str:
            return f'<a href="mailto:{value_str}" target="_blank" style="color:#000000;">{value_str}</a>'
        elif field_name == 'phone' and len(value_str) >= 7:
            return f'<a href="tel:{value_str}" style="color:#000000;">{value_str}</a>'
...
try:
    ...
    with col1:
        try:
            ...
            <div class="metric-card">
                ...
                <p style="color:#000000;">Google Sheets</p>
            </div>
            """, unsafe_allow_html=True)
        except Exception:
    ...
    with col2:
        try:
            ...
            st.markdown(f"""
            <div class="metric-card">
                <h3 style="color:#000000;">{client_count}</h3>
                <p style="color:#000000;">Total Clients</p>
            </div>
            """, unsafe_allow_html=True)
        except Exception:
    ...
    with col3:
        try:
            ...
            st.markdown(f"""
            <div class="metric-card">
                <h3 style="color:#000000;">{avg_completeness:.1f}%</h3>
                <p style="color:#000000;">Avg Completeness</p>
            </div>
            """, unsafe_allow_html=True)
        except Exception:
    ...
    with col4:
        try:
            ...
            st.markdown(f"""
            <div class="metric-card">
                <h3 style="color:#000000;">{last_update}</h3>
                <p style="color:#000000;">Last Updated</p>
            </div>
            """, unsafe_allow_html=True)
        except Exception:
                            ...
                            if selected_idx is not None and selected_idx in filtered_df.index:
                                try:
                                    ...
                                    <div class="profile-header">
                                        <h1 style='margin:0; font-size:2.5em; color:#000000;'>{full_name}</h1>
                                        <p style='margin:0.5rem 0 0 0; font-size:1.2em; opacity:0.9; color:#000000;'>{email}</p>
                                        <p style='margin:0.5rem 0 0 0; font-size:1em; opacity:0.8; color:#000000;'>Profile Completeness: {completeness:.1f}%</p>
                                    </div>
                                    """, unsafe_allow_html=True)
                                    ...
                                    for category, fields in FIELD_CATEGORIES.items():
                                        try:
                                            ...
                                            <div class="field-section">
                                                <h3 style='margin-top:0; color:#000000;'>{category}</h3>
                                            """, unsafe_allow_html=True)
                                            ...
                                            for field in fields:
                                                if field in CLIENT_FIELDS:
                                                    try:
                                                        ...
                                                        st.markdown(f"""
                                                        <div class="field-row">
                                                            <div class="field-label" style="color:#000000;">{field_label}:</div>
                                                            <div class="field-value" style="color:#000000;">{field_value}</div>
                                                        </div>
                                                        """, unsafe_allow_html=True)
                                                    except Exception as e:
                                    ...
                                    with action_col1:
                                        if st.button("📧 Send Email", key="send_email"):
                                            ...
                                            if email_addr and '@' in email_addr:
                                                ...
                                                st.markdown(f'<a href="mailto:{email_addr}" target="_blank" style="color:#000000;">Open Email Client</a>', unsafe_allow_html=True)
                                            else:
                                    ...
                                    with action_col2:
                                        if st.button("📞 Call Client", key="call_client"):
                                            ...
                                            if phone and len(phone) >= 7:
                                                ...
                                                st.markdown(f'<a href="tel:{phone}" style="color:#000000;">Call Now</a>', unsafe_allow_html=True)
                                            else:
...
try:
    ...
    <div style='text-align: center; color: #000000; padding: 2rem;'>
        <p style='color: #000000;'><strong>Live CRM Client Profiles</strong></p>
        <p style='color: #000000;'>🔄 Real-time Google Sheets Integration • 👥 Individual Client Views</p>
        <p style='color: #000000;'>Built with ❤️ using Streamlit + Google Sheets API</p>
    </div>
    """, unsafe_allow_html=True)
except Exception:
